...
//            throw new ResponseStatusException(HttpStatus.FORBIDDEN, "nicai");
        }
    }

//    public String myEncrypt(Class<?> clazz) {
//        try {
...
//    }
//
//    public Class myDecrypt(String auth, Class<?> clazz) {
//        try {
//            String json = encryptor.decrypt(auth);
//            return objectMapper.readValue(json, new TypeReference<Class>() {});
//        } catch (Exception c) {
//            throw new ResponseStatusException(HttpStatus.FORBIDDEN, "无权限");
//        }
//    }
